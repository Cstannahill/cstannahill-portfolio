"use client";
import { AWS_LOGO, JAVASCRIPT_LOGO, POSTGRES_LOGO, PYTHON_LOGO, REACT_LOGO, TYPESCRIPT_LOGO, type LogoSpec } from "@/components/shared/logos";
...
export function TechGrid() {
    const LOGOS = [PYTHON_LOGO, JAVASCRIPT_LOGO, AWS_LOGO, TYPESCRIPT_LOGO];
...
export function TechGrid2() {
    const LOGOS = [REACT_LOGO, POSTGRES_LOGO];
...
export function TechRow() {
    const LOGOS = [PYTHON_LOGO, JAVASCRIPT_LOGO, AWS_LOGO, TYPESCRIPT_LOGO, REACT_LOGO, POSTGRES_LOGO];
